...
const SliderItem = ({ item }) => {
  const insight = item.hero
  const media = insight.media.data.attributes
      ...
      <div className="auto__container">
        <div className="hero__inner">
          <div className="hero__inner-nav">
            <Breadcrumb array={insight.breadcrumb} />
          </div>
          <div className="heroSlide">
            <div className="heroSlide__title">
              <h1 className="big">{insight.title}</h1>
            </div>
            <Link href={insight.link.url} className="loadMore">
              <b>{insight.link.label}</b>
