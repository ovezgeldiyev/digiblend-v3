...
const SliderItem = ({ item }) => {
  ...
  const media = item.case.video.data.attributes
  return (
    <>
      ...
      <div className="auto__container">
        <div className="hero__inner">
          <div className="hero__inner-nav">
            <Breadcrumb array={item.case.breadcrumb} />
          </div>
          <div className="heroSlide">
            <div className="heroSlide__title">
              <h1 className="big">{item.title}</h1>
              <p>{item.subtitle}</p>
            </div>
            <Link href={item.case.link.url} className="loadMore">
              <b>{item.case.link.label}</b>
